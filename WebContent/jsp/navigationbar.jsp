<div id="navbar">
	...
	<ul class="navigation">
			...
			if (session.getAttribute("rank") == null) {
				...
				if (rank == 1) {
					out.print("<li class='dropdown'>"
							...
							+ "<li><a href='EditAccounts.jsp' >Edit Accounts</a></li>" + "</ul>" + "</li>");
				}

				if (rank == 0) {
					out.print("<li class='calendar'>" + "<a href='AdvisorCalendar.jsp' >Calendar</a>" + "</li>");
				...
				if (rank == 2 || rank == 9) {
					...
					out.print("<li class='profile'>" + "<a href='StudentProfile.jsp' >Profile</a>" + "</li>");
				}

				if (rank == 1 || rank == 0 || rank == 2 || rank == 9) {
					out.print("<li class='logout'>" + "<a href='logout.jsp' >Log Out</a>" + "</li>");
				}
		...
		<li class="dropdown"><a class="dropdown-toggle"
			data-toggle="dropdown" href="#"> Helpful Links <span
				class="caret"></span></a>
			<ul class="dropdown-menu" style="text-align: center">
				<li><a
					href="https://sis-portal-prod.uta.edu/psp/AEPPRD/EMPLOYEE/EMPL/h/?tab=PAPP_GUEST">
						My Mav</a></li>
				<br>
				<li><a href="http://www.uta.edu/uta/"> UTA </a></li>
				<br>
		...
		<form>
			<input id="sbox" name="searchBox"
				...
				onclick="reDirect()" id="sb" name="searchButton"
				style="position: absolute; padding-bottom: 20px; width: 80px; height: 20px; margin-top: -38px; margin-left: 530px;"
