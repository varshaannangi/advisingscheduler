...
function AdvisingType(){
	var type = document.forms["schedule"]["type"].value;
	if(type=="Others")
		{
		document.getElementById("otherAdvisingType").style.display = 'block';
		}
	else{
		document.getElementById("otherAdvisingType").style.display = 'none';
	}
}
            ...
            function validate() {
                ...
                if(email.indexOf("mavs.uta.edu") > 0) {
                    ...
                    if (sID.indexOf("10") === -1 && sID.indexOf("60") === -1) {
		...
		<div id="wrapper">
			...
			<div id="accordion" class="centerthis">
				...
				<div class="centerthis">
					<form role="form" name="schedule" action="StudentCalendar.jsp"
						...
						<div class="form-group">
							<label for="sID">Student ID</label> <input type="text"
								onkeypress="return isNumberKey(event)" name="sID" id="sID"
						...
						<div class="form-group">
							<label for="advisor">Advisor</label> <select name="advisor"
								id="advisor" class="form-control">
							</select>

						</div>
						<div class="form-group">
							<label for="type">Advising Type</label> <select name="type"
								id="type" class="form-control" onchange="AdvisingType()">
						...
						<div id="otherAdvisingType" class="form-group"
							style="display: none;">
							<input type="text" name="otherType" id="otherType" value=""
								class="form-control">
						</div>
						<div class="form-group">
							<label for="date">Date</label> <input type="text" name="date"
								id="date" readonly="false" class="form-control">
						</div>
						<div class="form-group">
						...
						<input type="submit" value="Submit" id="submitBtn"
							...
							value="Reset" id="resetBtn" class="btn btn-default">
					</form>
				</div>
			</div>
		</div>
