		...
		<div id="appointmentAccordion" class="centerthis">
			...
			<div>
				<%
					...
					if (request.getParameter("apptID") == null || request.getParameter("apptID)") == ""
							|| request.getParameter("apptID").equals("")) {
						...
						String date = "" + (appt.getDate().getMonth() + 1) + "/" + appt.getDate().getDate() + "/"
								+ (appt.getDate().getYear() + 1900);
						String startTime = "";
						String endTime = "";
				...
				<form name="edit" action="appointmentEdit.jsp" method="submit"
					...
					<div class="form-group">
						<label for="advisorName">Advisor</label> <input
							class="form-control" type="text" name="advisorName" size="50"
							id="advisorName" value="<%=advisorName%>" readonly="true">
					</div>
					<div class="form-group">
						<label for="advisingType">Advising Type</label> <input
							class="form-control" type="text" name="advisingType" size="50"
							id="advisingType" value="<%=type%>">
					</div>
					<div class="form-group">
						<label for="studentName">Student Name</label> <input
							class="form-control" type="text" name="studentName" size="50"
							id="studentName" value="<%=studentName%>" readonly="true">
						<input type="hidden" name="studentID" size="50" id="studentID"
							value="<%=studentID%>" readonly="true">
					</div>
					<div class="form-group">
						<label for="studentName">Student Major</label> <input
							class="form-control" type="text" name="studentMajor" size="50"
							id="major" value="<%=studentMajor%>" readonly="true">
					</div>
					<div class="form-group">
						<label for="date">Date</label> <input class="form-control"
							type="text" name="date" size="50" id="date" value="<%=date%>"
							readonly="true">
					</div>
					<div class="form-group">
						<label for="startTime">Start Time</label> <input
							class="form-control" type="text" name="startTime" size="50"
							id="startTime" value="<%=startTime%>">
					</div>
					<div class="form-group">
						<label for="endTime">End Time</label> <input class="form-control"
							type="text" name="endTime" size="50" id="endTime"
							value="<%=endTime%>">
					</div>
					<div class="form-group">
						<label for="endTime">Priority</label> <select name="priority"
					...
					<div class="form-group">
						...
						<textarea class="form-control" name="description" id="description"
							rows="6" cols="50"><%=description%></textarea>
					</div>
					<input type="hidden" value="false" name="remove"> <input
						type="submit" value="Edit Appointment" id="submitBtn"
				...
				<form method="submit" action="appointmentEdit.jsp">
					...
					<input type="hidden" value="true" name="remove"><br> <input
						type="submit" value="Cancel Appointment" id="cancelBtn"
						class="btn btn-default">
				</form>
				...
				%>
				<jsp:useBean id="mab"
					class="uta.cse4361.beans.ModifyAppointmentBean" scope="session" />
				<jsp:setProperty name="mab" property="apptID"
				...
				<jsp:setProperty name="mab" property="studentId"
					value='<%=appt.getStudentID()%>' />
				<jsp:setProperty name="mab" property="studentMajor"
					value='<%=appt.getStudentMajor()%>' />
				<jsp:setProperty name="mab" property="advisorName"
					value='<%=appt.getAdvisorName()%>' />
				<jsp:setProperty name="mab" property="description"
					value='<%=request.getParameter("description")%>' />
				<jsp:setProperty name="mab" property="type"
					value='<%=appt.getType()%>' />
				<jsp:setProperty name="mab" property="startHour"
					value='<%=appt.getStartHour()%>' />
				<jsp:setProperty name="mab" property="startMinute"
					value='<%=appt.getStartMinute()%>' />
				<jsp:setProperty name="mab" property="endHour"
					value='<%=appt.getEndHour()%>' />
				<jsp:setProperty name="mab" property="endMinute"
					value='<%=appt.getEndMinute()%>' />
				<jsp:setProperty name="mab" property="date"
					value='<%=appt.getDate()%>' />
