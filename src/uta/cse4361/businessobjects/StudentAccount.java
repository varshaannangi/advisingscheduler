...
public class StudentAccount {
    ...
    public boolean initialize(String name, String email, String major, int ID, int rank, Timestamp timeStamp){
        boolean result = true;
    ...
    public boolean initialize(String name,String tempPassword, String email,String uname, String major, int rank){
        boolean result = true;
