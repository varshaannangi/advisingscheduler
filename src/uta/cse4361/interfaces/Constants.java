...
public interface Constants {
    ...
    final static String CREATE_STUDENT_FAIL = "Student can't be added";
    final static String STUDENT_ALREADY_REGISTERED = "Student is already registered!";
    ...
    //Email Types
    final static String EMAIL_REQUEST = "REQUEST";
    final static String EMAIL_CANCEL = "CANCEL";
}
